...
const server = createServer(async (req, res) => {
  cors()(req, res, async () => {
    ...
    if (method === "GET") {
      if (pathName.startsWith("/uploads/")) {
        //@ts-ignore
        const tempFilePath = "path/to/temporary/file"; // Substitua pelo caminho do arquivo temporário
        const destinationFilePath = "path/to/destination/file"; // Substitua pelo caminho do arquivo de destino
